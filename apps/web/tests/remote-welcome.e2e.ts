// Trusted non-loopback Web access with settings persistence persists the
// welcome notice across reloads.
...
describe.skipIf(MODE === 'record')('web e2e: remote welcome notice', () => {
  ...
  it('advances and persists the notice acknowledgment across reload', async () => {
